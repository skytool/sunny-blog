...
ActiveRecord::Schema[8.1].define(version: 2026_03_25_015931) do
  ...
  create_table "travel_reviews", force: :cascade do |t|
    ...
    t.integer "user_id", null: false
    t.date "visited_at"
    t.index ["travel_spot_id"], name: "index_travel_reviews_on_travel_spot_id"
  ...
  add_foreign_key "travel_reviews", "travel_spots"
